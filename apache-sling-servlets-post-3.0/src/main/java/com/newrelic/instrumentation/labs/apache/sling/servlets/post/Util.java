package com.newrelic.instrumentation.labs.apache.sling.servlets.post;
...
public class Util {
	...
	public static void  recordRequestAttributes(SlingJakartaHttpServletRequest request) {
	...
	public static void recordRequestParams(Map<String, Object> attributes, SlingJakartaHttpServletRequest request) {
		if(request != null) {
